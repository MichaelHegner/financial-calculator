...
class AnnuityCalculatorSpecialRedemptionInYearTest {
	def capital, interest, expected
	
	
	public AnnuityCalculatorSpecialRedemptionInYearTest(capital, interest, expected) {
	...
	public void testInterestToQuote() {
		def interest = AnnuityCalculator.calculateInterestAmountOfFirstYear(capital, interest)
